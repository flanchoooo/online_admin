    ...
    <article>
        ...
        <table class="meta">
            <tr>
                ...
                <td><span>{{$quotation}}</span></td>
            </tr>
            <tr>
                <th><span>Date</span></th>
                <td><span>{{\Carbon\Carbon::now()->format('d M Y')}}</span></td>
            </tr>
        </table>
        <table class="inventory">
            ...
            <tr>
                ...
                <th><span>Covered By Medical Aid</span></th>
                <th><span>Shortfall</span></th>
            </tr>
            </thead>
            <tbody>
            @foreach($items as $item)
                <tr>
                    ...
                    <td>{{$item['qty']}}</td>
                    <td>${{number_format($item['deducted'],2,',','.')}}</td>
                    <td>${{number_format(($item['qty'] * $item['price'])-$item['deducted'],2,',','.')}}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
